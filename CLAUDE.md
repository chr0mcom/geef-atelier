...
**Vector-Store-Grounding-Provider (Phase 2 RAG) deployed (14. Mai 2026).** PS-1 ✅ PS-2 ✅ PS-3 ✅ PS-4 ✅ PS-5 ✅ PS-6 ✅ PS-7 ✅ + CLI-Split ✅ + Model-Catalog ✅ + Grounding-Viz ✅ + Vector-Store-RAG ✅. D-036: `VectorStoreGroundingProvider` (IGroundingProvider, `ProviderType="vector-store"`), `OpenRouterEmbeddingProvider` (text-embedding-3-small, 1536 dim), `RecursiveCharacterTextSplitter`, `KnowledgeDocuments`/`KnowledgeDocumentChunks` (HNSW via pgvector 0.8.2), Knowledge-Management-UI unter `/crew/knowledge`, MCP-Tool `list_knowledge_documents`. 400 C#-Tests grün, 43 Python-Tests grün. D-035: Tavily-Grounding (D-035). Postgres-Image: `pgvector/pgvector:pg16`.

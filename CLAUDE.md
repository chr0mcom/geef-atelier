...
**Domain-Templates deployed (18. Mai 2026).** PS-1 ✅ PS-2 ✅ PS-3 ✅ PS-4 ✅ PS-5 ✅ PS-6 ✅ PS-7 ✅ + CLI-Split ✅ + Model-Catalog ✅ + Grounding-Viz ✅ + Vector-Store-RAG ✅ + Run-Attachments ✅ + PDF-Support ✅ + Cost-Tracking ✅ + Template-Studio ✅ + Domain-Templates ✅. 628 Tests (627 grün + 1 bekannter E2E-Flake). Domain-Templates: `juristisch` (Sequential, legal-domain-expert Advisor), `akademisch` (Sequential, academic-rigor-advisor), `marketing` (Parallel, kein Advisor). 6 neue System-Reviewer: legal-jargon-precision (gpt-4o-mini), legal-clause-risk (claude-sonnet-4-5), academic-citation-readiness (gpt-4o-mini), academic-argumentation-rigor (claude-sonnet-4-5), marketing-audience-clarity (gemini-2.5-flash), marketing-conversion-strength (gpt-4o-mini). 2 neue System-Advisors: legal-domain-expert (DomainExpert/BeforeFirst/sonnet-4-5), academic-rigor-advisor (Critical/BeforeEvery/gpt-4o-mini). DomainBadge.razor, Migration Step18 (No-op). ReviewerProfiles-Dict: 2→8, AdvisorProfiles-Dict: 2→4, CrewTemplates: 1→4. Template Studio: `/crew/studio` Meta-KI-Wizard (5 Steps), Migration `Step17TemplateStudio`. D-038: `TemplateStudioAnalysis`, `TemplateStudioAnalyses`-JSONB-Tabelle, `ProfileSimilarityService`. PDF via PdfPig 0.1.14 (max 25 MB). D-037: `KnowledgeScope`-Enum (Global/RunLocal), `KnowledgeDocument.RunId` + FK mit `ON DELETE CASCADE`, `SystemCrew.RunAttachmentsProfile`. D-036: `VectorStoreGroundingProvider`, `OpenRouterEmbeddingProvider`, pgvector 0.8.2. Postgres-Image: `pgvector/pgvector:pg16`.

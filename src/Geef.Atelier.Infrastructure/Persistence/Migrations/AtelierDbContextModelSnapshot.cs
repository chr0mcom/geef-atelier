...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Geef.Atelier.Infrastructure.Persistence.Entities.ToolDefinitionEntity", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<int>("AccessClass")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("LlmSchemaJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'{}'::jsonb");
            ...
            modelBuilder.Entity("Geef.Atelier.Core.Domain.Tools.ToolInvocation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("OutputExcerpt")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "RunId", "Sequence" }, "IX_tool_invocations_RunId_Sequence")
                        .IsUnique();

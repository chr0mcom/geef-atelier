...
## Accepted Deviations from Blueprint (Evaluation Iteration 1)

These deviations were identified in the R4 Architectural Review and are **intentionally accepted**. R4 reviewers in subsequent iterations must not re-flag them as findings.
